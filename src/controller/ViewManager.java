...
public class ViewManager {
    ...
    /**
     * Returns an instance of the controller.ViewManager class, creating one if necessary.
     *
     * @param views the parent container
     * @return an instance of the controller.ViewManager class
     */
    ...
    /**
     * Adds a new model.Product to inventory.
     *
    ...
    /**
     * Modifies an existing model.Product in inventory.
     *
    ...
    /**
     * Removes an existing model.Product from inventory.
     *
    ...
    /**
     * Adds an model.OrderItem to an model.Order, creating the model.Order first if necessary.
     *
    ...
    /**
     * Modify the quantity of an model.OrderItem in an model.Order.
     *
    ...
    /**
     * Remove an model.OrderItem from an existing model.Order.
     *
     * @param product the product to be removed
     */
    ...
    /**
     * Returns the model.OrderItem quantity by model.Product.
     *
    ...
    /**
     * Returns the subtotal for this model.Product.
     *
    ...
    /**
     * Returns whether or not the model.Product already exists in the model.Order.
     *
